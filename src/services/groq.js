...
async function searchWebGroq(query, locationContext = '', nomeUsuario = '', tomUsuario = 'carinhoso', contextoRelacional = '', modo = 'informar') {
  try {
